public class MainClass {
    public static void main(String[] args) {
        ...
        DataBase.addToDataBase(client1.getIdClientAndNameProduct(creditCard), creditCard);
        ...
        DataBase.addToDataBase(client1.getIdClientAndNameProduct(investment), investment);
        ...
        DataBase.addToDataBase(client1.getIdClientAndNameProduct(currencyCard), currencyCard);
...
//        создаем дебетовую карту для нового клиента и самого клиента + добавляем в бд и провеяем, что продукт для клиента туда добавлен
        ...
        DataBase.addToDataBase(client2.getIdClientAndNameProduct(debitCard), debitCard);
        ...
        client2.checksBalance(debitCard);
        client2.writeOffMoneyFromAccount((DebitCardImpl) debitCard, 10000.00, creditCard);
        client2.checksBalance(creditCard);
        client2.getsIndebtedness((CreditCard) creditCard);
